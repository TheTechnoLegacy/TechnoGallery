...
class ImageGallery$MyThumbCheckCallback$3 implements java.lang.Runnable {
    final /* synthetic */ com.techno.gallery.ImageGallery.MyThumbCheckCallback this$1;

    ImageGallery$MyThumbCheckCallback$3(com.techno.gallery.ImageGallery.MyThumbCheckCallback r1) {
        r0 = this;
        r0.this$1 = r1;
        r0.<init>();
        return;
