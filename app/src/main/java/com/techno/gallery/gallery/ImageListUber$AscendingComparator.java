...
class ImageListUber$AscendingComparator implements java.util.Comparator<com.techno.gallery.gallery.ImageListUber.MergeSlot> {
    private ImageListUber$AscendingComparator() {
        r0 = this;
        r0.<init>();
        return;
    }

    /* synthetic */ ImageListUber$AscendingComparator(com.techno.gallery.gallery.ImageListUber.1 r1) {
        r0 = this;
        r0.<init>();
        return;
    }
